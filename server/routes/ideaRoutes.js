...
import { getIdeas, getSingleIdea, createIdea, updateIdea, deleteIdea, getStarredIdeas } from '../controllers/ideaControllers.js'   // Import the functions from the ideasController.js file
import authMiddleware from '../middlewares/authMiddleware.js';

router.get('/:creator_id', authMiddleware, getIdeas);  // GET request to fetch all ideas
router.get('/:creator_id/starred', authMiddleware, getStarredIdeas);  // GET request to fetch all ideas
